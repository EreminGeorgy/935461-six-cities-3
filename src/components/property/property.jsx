...
export const Property = (props) => {
  ...
  const avaliableItems = Array.from(householdItems);
      ...
      <section className="property">
        <div className="property__gallery-container container">
          <div className="property__gallery">
            {imagesSrc.map((src) => {
              return (<div className="property__image-wrapper" key={shortid.generate()}>
            ...
            <div className="property__inside">
              ...
              <ul className="property__inside-list">
                {avaliableItems.map((item) => {
                  return (<li className="property__inside-item" key={shortid.generate()}>
                    {item}
                  </li>);
                })}
              </ul>
            ...
            <div className="property__host">
              ...
              <div className="property__description">
                {description.map((descriptionText) => {
                  return (<p className="property__text" key={shortid.generate()}>
                    {descriptionText}
                  </p>);
                })}
              </div>
